...
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdParam, int nCmdShow)
{
	...
	//WndClass.hbrBackground = (HBRUSH)GetStockObject(WHITE_BRUSH);	//윈도우 배경색 ->흰색
	WndClass.hbrBackground = (HBRUSH)GetStockObject(DKGRAY_BRUSH);	//윈도우 배경색 ->진한 회색
	...
	hWnd = CreateWindow(lpszClass, L"LOVE", WS_OVERLAPPEDWINDOW,
		100, 100, 720, 480,
